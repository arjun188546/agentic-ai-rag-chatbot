...
\# \- N8N\_WEBHOOK\_URL=http://localhost:5678/webhook-test/chat
...
OPENAI\_API\_KEY=sk-your-key-here        \# Get from OpenAI dashboard

N8N\_WEBHOOK\_URL=http://localhost:5678/webhook/chat

\# Optional

API\_TIMEOUT=30000                      \# 30 second timeout

MAX\_RESULTS=5                          \# Max search results per query

## 📖 More Documentation

- [**Architecture Deep Dive**](http://docs/n8n-workflow-architecture.md) \- How it all works(github repo)  
- [**Project Overview**](http://docs/project-overview.md) \- Full feature list(github repo)  
- [**Deployment Guide**](http://docs/deployment-guide.md) \- Production setup(github repo)
